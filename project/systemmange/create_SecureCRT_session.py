...
#IP_ADD = "192.168.7.193"
str1 = """D:"Is Session"=00000001
...
S:"Username"=root
D:"[SSH2] 端口"=00000016
S:"Password"=u4ad7cac14ec3f220fbbf434f4ec6566f7124cd4c6722f2b209e4d1bc7522c980
...
B:"Window Placement"=0000002c
 2c 00 00 00 00 00 00 00 01 00 00 00 ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ec 03 00 00
 f6 00 00 00 52 07 00 00 30 03 00 00
...
S:"Script Filename"=
S:"Upload Directory"=C:\\Users\Administrator
S:"Download Directory"=C:\\Users\Administrator\Downloads
...
"""
fp_lst = open("D:\\x2.csv","r")
for x in fp_lst:
    IP_ADD=x.replace("\n","")
    print(IP_ADD,end="")
    res = str1 + IP_ADD + str2
    #print(res,end="")
    fp = open(IP_ADD + ".ini","w")
    fp.write(res)
